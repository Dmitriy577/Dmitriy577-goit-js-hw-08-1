...
let formData = (0, _storageJs.getItemKey)(FEEDBACK_FORM_STATE) || {};
const form = document.querySelector(".feedback-form");
form.addEventListener("input", (0, _lodashThrottleDefault.default)(saveValue, 500));
function saveValue(e) {
    formData[e.target.name] = e.target.value;
    (0, _storageJs.save)(FEEDBACK_FORM_STATE, JSON.stringify(formData));
}
localStorageValue();
function localStorageValue() {
    const exam = (0, _storageJs.getItemKey)(FEEDBACK_FORM_STATE);
    if (exam) {
        if (exam.email) form.email.value = exam.email;
        if (exam.message) form.message.value = exam.message;
    }
}
...
function handleSubmit(e) {
    ...
    (0, _storageJs.removeKey)(FEEDBACK_FORM_STATE);
...
parcelHelpers.export(exports, "getItemKey", ()=>getItemKey);
parcelHelpers.export(exports, "removeKey", ()=>removeKey);
